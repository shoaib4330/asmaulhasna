...
public final class AllahName_Dao implements IAllahNameDao {
    ...
    public List<AllahName> getList(String input_trans_lang, Context context) {
        ...
        List<String> listOfNames_translated;
        if (input_trans_lang.equals("urdu"))
        {
            listOfNames_translated  = Arrays.asList(context.getResources().getStringArray(R.array.Allah_Name_TransLation_Urdu));
        }
        else{
            listOfNames_translated = Arrays.asList(context.getResources().getStringArray(R.array.Allah_Name_TransLation_English));
        }
        ...
        for (int index=0; index < listOfNames_Arabic.size(); index++)
        {
            ...
            currentName.setTranslation(listOfNames_translated.get(index));
